...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/bf6fc8dbbee7827fe1a46.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 10k PERMANEN\n⭔ 5k 1BULAN\n\n Premium Price Bot\n⭔ 5k per User 1 bulan\n 3K 1 MINGGU\n ALL Payment  owner\nhttps://wa.me/6288292024190 (Owne` }, { quoted: m })
            }
            break
            case 'sc': {
